...
export default function UpdateNews() {
    ...
    console.log(id);
    useEffect(() => {
        axios.get(`http://localhost:3001/news/${id}`).then((data) => {
    ...
    async function HandleSubmit(e) {
        e.preventDefault();
        try {
            const res = await axios.patch(`http://localhost:3001/news/update/${id}`,
                {
                    title: title,
    ...
    return (
        <div>
            <h2 style={{marginLeft:"7%"}}> Update News </h2>
            ...
            <form onSubmit={HandleSubmit} >
                ...
                Upload
                        ...
                        {/* </div>   <RichTextEditor setvalue={setdescription} config={config} value={description} onChange={(e) => setdescription(e.target.value)} /> */}
